				...
				<div id="logoLogin">
					<form method="post" id="formLogin" action="">
						...
						<div class="clearfix">
							<label>Senha:</label>
							<div class="input">
								<input type="password" maxlength="16" class="span2-5" name="senha" id="senha">
							</div>
						</div>
						<button type="submit" id="logar" class="btn primary">Logar</button>
					</form>
						
					<form method="post" id="formConta" action="/fuxico/conta">
						<div id="contaGeral">
							<div id="conta">
								<div id="erroConta">${erroConta}</div>
								<div id="ok">${ok}</div>
								<div class="clearfix">
									<label>Login:</label>
									<div class="input">
										<input type="text" class="campo" maxlength="32" name="usuario.login">
									</div>
								</div>
								<div class="clearfix">
									<label>Senha:</label>
								...
								<div class="clearfix">
									<label>Nome:</label>
									<div class="input">
										<input class="nome" type="text" maxlength="255"	name="usuario.nome">
									</div>
								</div>
								<div class="clearfix">
									<label>Email:</label>
									<div class="input">
										<input class="email" type="text" maxlength="64"	name="usuario.email">
									</div>
								</div><br>
								<button type="submit" id="criar" class="btn primary">Criar Conta</button>
							</div>
						</div>
					</form>
				</div>
